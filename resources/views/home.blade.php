...
<div id="container">
    <div id="post-list">
        ...
        <div class="post" id="post-{{ $post->post_id }}}">
            <div class="post-header">
                ...
                <div class="post-date">
                    <a href="/category/date/<?php echo date('Y-m',strtotime($post->post_date)); ?>"><?php echo date('Y-m-d',strtotime($post->post_date)); ?></a>
                </div>
                <div class="post-tag">
    ...
    <div class="pager text-center">
        <!--上一页-->
        @if(!empty($pager['prev']))
            <a class="ui tiny basic button " href="/home?page={{ $pager['prev'] }}">上一页</a>
        @endif
        <!--下一页-->
        @if(!empty($pager['next']))
            <a class="ui tiny basic button" href="/home?page={{ $pager['next'] }}">下一页</a>
        @endif
    </div>
